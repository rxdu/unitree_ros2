#include "unitree_driver/ros2_sport_client.h"
...
void SportClient::FootRaiseHeight(unitree_api::msg::Request &req,
                                  float height) {
  nlohmann::json js;
  js["data"] = height;
  req.parameter = js.dump();
...
void SportClient::TrajectoryFollow(unitree_api::msg::Request &req,
